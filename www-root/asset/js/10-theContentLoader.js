    ...
    var methods = {
        ...
        loadUp: function(count, eventHandlers){
            return this.each(function(){
                ...
                $(this).theContentLoader("_load", "theContentLoader_nothingUpAt", query, newEventHandlers);
            });
        },
        loadDown: function(count, eventHandlers){
            return this.each(function(){
                ...
                $(this).theContentLoader("_load", "theContentLoader_nothingDownAt", query, newEventHandlers);
            });
        },
